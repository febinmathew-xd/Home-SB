                            ...
                            <div className="full">
                                <div className="footer-widget">
                                    ...
                                    <ul className="social-icons style-4 pull-left">
                                        ...
                                        <li><a className="pinterest" href="#"><i className="fa-brands fa-pinterest-p"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="full">
                                <div className="footer-widget">
                                    ...
                                    <ul className="address-list">
                                        ...
                                        <li><i className="fa-solid fa-location-dot"></i>Opposite Technopark, Kazhakkoottam, Trivandrum</li>
                                        <li><i className="fa fa-phone"></i>9747990203</li>
